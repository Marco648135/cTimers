...
public enum PlayerAnimation
{
	...
	SANG("Sang/Trident", "T", new Color(30, 120, 130), 4, new int[]{1167, 11430}, new int[]{}, new int[]{ItemID.SANGUINESTI_STAFF, ItemID.HOLY_SANGUINESTI_STAFF, ItemID.TRIDENT_OF_THE_SEAS, ItemID.TRIDENT_OF_THE_SEAS_E, ItemID.TRIDENT_OF_THE_SEAS_FULL, ItemID.TRIDENT_OF_THE_SWAMP, ItemID.TRIDENT_OF_THE_SWAMP_E}, new int[]{1539, 1040, 1252}, 0, Style.MAGE),
	...
	WARD_OF_ARCEUUS("Ward of Arceuus", "WA", new Color(70, 70, 70), -1, new int[]{8970}, new int[]{1851}, new int[]{}, new int[]{}, 0, Style.NON_COMBAT),
	...
	HUNTER_KIT("Hunter Kit", "HK", new Color(50, 50, 50), -1, new int[]{6303},new int[]{1074},new int[]{},new int[]{},0, Style.NON_COMBAT)
	;
