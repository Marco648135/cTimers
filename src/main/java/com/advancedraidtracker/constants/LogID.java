...
public enum LogID
{
    ...
    HAMMER_HIT(2, true, ANY,
            ...
            new ParseInstruction(MAP, HAMMERS_HIT),
			new ParseInstruction(MANUAL_PARSE),
            new ParseInstruction(DWH, DEFENSE),
            "Hammer Hit", "Player", "Room Tick"),
    HAMMER_MISS(20002, true, ANY,
            new ParseInstruction(MANUAL_PARSE),
            "Hammer Miss", "Player", "Room Tick"),
    SHADOW_BARRAGE(20003, true, ANY,
            new ParseInstruction(MANUAL_PARSE),
            "Shadow Barrage", "Player", "Room Tick"),
    BGS_HIT(3, true, ANY,
    ...
    MAIDEN_DESPAWNED(17, true, MAIDEN,
            ...
            new ParseInstruction(ADD_TO_VALUE, NYLO_ENTRY),
            new ParseInstruction(ADD_TO_VALUE, SOTE_ENTRY),
            new ParseInstruction(ADD_TO_VALUE, XARP_ENTRY),
            new ParseInstruction(ADD_TO_VALUE, VERZIK_ENTRY),
	...
	NYLO_STALL_ALIVE(38, false, NYLOCAS,
		new ParseInstruction(MANUAL_PARSE),
		"Nylo Stall Alive", "Wave", "Room Tick", "Description", "Age"),
	NYLO_KILLED(39, false, NYLOCAS,
		new ParseInstruction(MANUAL_PARSE),
		"Nylo Killed", "Room Tick", "Age", "Description"),
	...
	BLOAT_PLAYER_HANDED(987, false, BLOAT, new ParseInstruction(MANUAL_PARSE),
